import noTrips from "/assets/icons/noTrip.png";
export default function NoTrips() {
    return (
        <div className="flex flex-col items-center justify-center p-6 min-h-[800px] bg-white rounded-xl">
            <img src={noTrips} alt="No Trips" className="w-32 h-32 mb-4" />
            {/* search */}
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">You haven’t booked any stays yet.</h2>
            <p className="text-gray-500">
                Discover and book your next getaway now!        </p>
        </div>
    )
}
